...
Vimos que el algoritmo exacto es inutilizable en la práctica para grafos con mas de 30 nodos, así que es necesario recurrir a heurísticas que la resuelvan. \\
