...
\todo[inline]{Insertar grafico de tiempos con grafos random}

\todo[inline]{Insertar grafico de cliques con grafos random}

\todo[inline]{Aca puede verse como la solucion en casos malos blabalbalb}
{\centering
    \includegraphics[width=0.9\textwidth]{informe/imgs/exp_malo_frontera_greedy_exacta.pdf}
    \textit{FRONTERA CON GRAFOS MALOS}
}
