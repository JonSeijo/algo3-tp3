...
\begin{itemize}
    ...
    \todo[inline]{¿Cómo `$|v| = \frac{n}{2}$, entonces el tamaño del complemento también es $\frac{n}{2}$'?}
...
\todo[inline]{El texto pareece sugerir que $golosoB+busquedaLocal$ nunca es peor $golosoA$. Yo escribiria un paréntesis por las dudas para aclarar que no, what do you think?}
