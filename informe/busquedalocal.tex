...
\todo[inline]{Terminó siendo lo mismo, pero hay que tener en cuenta que este es un tipo particular de grafo. Veremos en la última seccion como se comporta en el caso de grafos aleatorios}
